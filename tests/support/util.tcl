...
proc generate_fuzzy_traffic_on_key {key type duration} {
    ...
    set timeseries_commands {TS.SET TS.GET TS.RANGE}
    set commands [dict create string $string_commands hash $hash_commands zset $zset_commands list $list_commands set $set_commands stream $stream_commands vectorset $vset_commands array $array_commands timeseries $timeseries_commands]
if 0 {
